...
namespace Razomy.Unity.Scripts.Ocean.Overlays
{
  ...
  public class OverlayFoamTexture
  {
    ...
    [Range(0.0f, 4.0f)] public float alpha = 1.0f;

    public Texture mask;
    public OVERLAY_MASK_MODE maskMode = OVERLAY_MASK_MODE.WAVES;

    [Range(0, 1)] public float maskAlpha = 1.0f;

    public bool IsDrawable => (alpha != 0.0f && tex != null) || (maskAlpha != 0.0f && mask != null);
  }
  ...
  public class OverlayClipTexture
  {
    ...
    public bool IsDrawable => alpha != 0.0f && tex != null;
  }
}