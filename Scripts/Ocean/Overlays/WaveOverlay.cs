...
namespace Ceto
{
  ...
  public class WaveOverlay
  {
    ...
    /// </summary>
    public float Age => OceanTime() - Creation;
    ...
    /// </summary>
    public float NormalizedAge => Duration != 0.0 ? Mathf.Clamp01(Age / Duration) : 1.0f;

    /// <summary>
    ///   The overlay quads corner positions in world space.
    /// </summary>
    public Vector4[] Corners { get; }
    ...
    {
      var hs = new Vector3(HalfSize.x, 1.0f, HalfSize.y);
    ...
    public virtual void CalculateBounds()
    {
      ...
      var c = new Vector3(Position.x, level, Position.z);

      var s = new Vector3(xmax - xmin, hs.y, zmax - zmin);
    ...
    public bool Contains(float x, float z, out float u, out float v)
    {
      ...
      var ca = Mathf.Cos(r * Mathf.PI / 180.0f);
      var sa = Mathf.Sin(r * Mathf.PI / 180.0f);
