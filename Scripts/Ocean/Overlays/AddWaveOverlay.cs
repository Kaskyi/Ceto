...
namespace Razomy.Unity.Scripts.Ocean.Overlays
{
  ...
  public class AddWaveOverlay : AddWaveOverlayBase
  {
    ...
    ///   at this locations.
    /// </summary>
    public OverlayHeightTexture heightTexture = new();

    /// <summary>
    ///   Allows the normal to be modified
    ///   at this locations.
    /// </summary>
    public OverlayNormalTexture normalTexture = new();

    /// <summary>
    ///   Allows the wave foam to be modified
    ///   at this locations.
    /// </summary>
    public OverlayFoamTexture foamTexture = new();

    /// <summary>
    ///   Allows the ocean mesh to be clipped
    ///   at this locations.
    /// </summary>
    public OverlayClipTexture clipTexture = new();
    ...
    private void OnDrawGizmos()
    {
      ...
      var hs = new Vector3(width * 0.5f, 1.0f, height * 0.5f);
      var pos = transform.position;

      var ltw = Matrix4x4.TRS(new Vector3(pos.x, 0.0f, pos.z), Quaternion.Euler(0, Rotation(), 0), hs);
