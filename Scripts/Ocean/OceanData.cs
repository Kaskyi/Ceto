...
namespace Ceto
{
  ...
  public struct AbsorptionModifier
  {
    ...
    [Range(0.0f, 50.0f)] public float scale;

    //Adjust the intensity of the final color.
    [Range(0.0f, 10.0f)] public float intensity;
  ...
  public struct InscatterModifier
  {
    ...
    [Range(0.0f, 5000.0f)] public float scale;

    //Adjust the intensity of the final color.
    [Range(0.0f, 2.0f)] public float intensity;
  ...
  public struct CausticModifier
  {
    ...
    /// </summary>
    [Range(0.0f, 3.0f)] public float aboveDistortion;

    [Range(0.0f, 3.0f)] public float belowDistortion;

    /// <summary>
    ///   The caustic distortion
    /// </summary>
    [Range(0.0f, 1.0f)] public float depthFade;

    /// <summary>
    ///   The caustic intensity
    /// </summary>
    [Range(0.0f, 3.0f)] public float intensity;
