...
namespace Razomy.Unity.Scripts.Common.Queues
{
  ...
  {
    private readonly Dictionary<VALUE, LinkedListNode<VALUE>> m_dictionary;
    private readonly LinkedList<VALUE> m_list;
