...
namespace Razomy.Unity.Scripts.Common.Queues
{
  ...
  {
    private readonly Dictionary<KEY, LinkedListNode<KeyValuePair<KEY, VALUE>>> m_dictionary;
    private readonly LinkedList<KeyValuePair<KEY, VALUE>> m_list;
    ...
    {
      get => m_dictionary[key].Value.Value;
    ...
    /// </summary>
    public bool IsEmpty => m_dictionary.Count == 0;
    ...
    public IEnumerator<VALUE> GetEnumerator()
    {
      ...
      while (e.MoveNext()) yield return e.Current.Value;
    }
