...
namespace Ceto
{
  ...
  public class CustomWaveSpectrumExample : MonoBehaviour, ICustomWaveSpectrum
  {
    ...
    /// </summary>
    [Range(0.0f, 30.0f)] public float windSpeed = 10.0f;

    private void Awake()
    {
      //Grab the WaveSpectrum and add this to the CustomWaveSpectrum interface.
      var spectrum = GetComponent<WaveSpectrum>();
    ...
    /// </summary>
    public bool MultiThreadTask => true;
    ...
    public ISpectrum CreateSpectrum(WaveSpectrumConditionKey key)
    {
      ...
      var k = key as CustomSpectrumConditionKey;
      ...
      var windSpeed = k.WindSpeed;
      var windDir = k.WindDir;
    ...
    {
      public CustomSpectrumConditionKey(float windSpeed, int size, float windDir, SPECTRUM_TYPE spectrumType,
        int numGrids)
      ...
      protected override bool Matches(WaveSpectrumConditionKey k)
      {
        ...
        var key = k as CustomSpectrumConditionKey;
