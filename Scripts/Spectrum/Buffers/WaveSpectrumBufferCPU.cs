...
namespace Ceto
{
  ...
  public abstract class WaveSpectrumBufferCPU : WaveSpectrumBuffer
  {
    ...
    /// </summary>
    private readonly List<FourierTask> m_fourierTasks;
    ...
    public override void Release()
    {
      ...
      {
        Object.Destroy(m_buffers[i].map);
    ...
    public bool IsDone()
    {
      ...
      var count = m_fourierTasks.Count;
      for (var i = 0; i < count; i++)
      {
    ...
    public override void Run(WaveSpectrumCondition condition, float time)
    {
      ...
      var numBuffers = m_buffers.Length;
